           ...
           <SinglePickerMaterialDialog
            ...
            <ScrollView style={styles.container}>
                ...
                <View  style={styles.containerPadding}>
                    ...
                    <Button style={styles.buttonPlay} icon="play" mode="contained" color="#fff" uppercase={false}>Assistir</Button>
                    <Paragraph>
                        {filme.descricao}
                    </Paragraph>
                    <Caption style={styles.captionInfos}>
                        Elenco: {' '} <Caption style={styles.captionWhite}>{filme.elenco.join(', ')}</Caption>{' '}
                        Gêneros: {' '} <Caption style={styles.captionWhite}>{filme.generos.join(', ')}</Caption>{' '}
                        Cenas e momentos: {' '} <Caption style={styles.captionWhite}>{filme.cenas_momentos.join(', ')}</Caption>{' '}
                    </Caption>
                    ...
                    {filme.tipo == 'serie' ? (
                        <>
                            ...
                            <FlatList data={episodios} renderItem={({item, index}) => (
                                <Episodio episodio={item} key={index} />
                            )}/>
                        </>
                    ) : null}
                </View>
                {filme.tipo == 'filme' ? <Secao secao={secao} hasTopBorder /> : null}
            </ScrollView>
        </>
    )
}
